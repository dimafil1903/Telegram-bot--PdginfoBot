...
$bot_username = 'PdgInfoBot'; // Without "@"

try {
    $bot = new TelegramBot\TelegramBotManager\BotManager([
        // Add you bot's API key and name
        'api_key' => '815372366:AAFqv3iHpN7fdZRoU-THnPsNflJu2qTpEIw',
        ...
        'webhook' => [
            ...
            'url' => 'https://www.bot.pidgorodne.info/bot2/hook.php',
